...
export const typeStyles: { [key: string]: TypeStyle } = {
  ...
  ice:      { backgroundColor: 'rgba(116, 214, 214, 0.9)', color: '#000000' },
  ...
  flying:   { backgroundColor: 'rgba(224, 219, 240, 0.9)', color: '#FFFFFF' },
  ...
  steel:    { backgroundColor: 'rgba(114, 114, 119, 0.94)', color: '#000000' },
